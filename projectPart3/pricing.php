...
<body>
    ...
    <div class="section">
        ...
        <h1>Pricing</h1>
        <img src="https://www.reactev.com/sites/default/files/field/image/Blog_Reactev_queespricing.jpg" alt="design graphic" width=900 height=500>
        <h3>Unfortunately, due to the wide variety of solutions we offer, we can not apply a predefined price.
            </h3>
        <div class="section">   
        <h3>Contact us today for your competitive quote!</h3>
